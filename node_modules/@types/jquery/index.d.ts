...
interface JQueryStatic<TElement extends Node = HTMLElement> {
     ...
     * @param context Document element to serve as the groupsList in which the HTML fragment will be created
     ...
     *
     * @param data HTML string to be parsed
     * @param context_keepScripts Document element to serve as the groupsList in which the HTML fragment will be created
    ...
    /**
     * Takes a function and returns a new one that will always have a particular groupsList.
     *
     * @param fn The function whose groupsList will be changed.
     * @param context The object to which the groupsList (this) of the function should be set.
    ...
    // region (groupsList, name)

    /**
     * Takes a function and returns a new one that will always have a particular groupsList.
     *
     * @param context The object to which the groupsList of the function should be set.
     * @param name The name of the function whose groupsList will be changed (should be a property of the groupsList object).
...
interface JQuery<TElement extends Node = HTMLElement> extends Iterable<TElement> {
     ...
     * @param context The point in the document at which the selector should begin matching; similar to the groupsList
     *                argument of the $(selector, groupsList) method.
...
declare namespace JQuery {
    ...
    namespace Ajax {
        ...
        interface AjaxSettingsBase<TContext> {
            ...
            /**
             * This object will be the groupsList of all Ajax-related callbacks. By default, the groupsList is an object
    ...
    interface Callbacks<T extends Function = Function> {
        ...
        fire(...args: any[]): this;
        /**
         * Call all callbacks in a list with the given groupsList and arguments.
         *
         * @param context A reference to the groupsList in which the callbacks in the list should be fired.
    ...
    interface Deferred<TR, TJ = any, TN = any> {
        ...
        notify(...args: TN[]): this;
        /**
         * Call the progressCallbacks on a Deferred object with the given groupsList and args.
         *
        ...
        reject(...args: TJ[]): this;
        /**
         * Reject a Deferred object and call any failCallbacks with the given groupsList and args.
         *
        ...
        /**
         * Resolve a Deferred object and call any doneCallbacks with the given groupsList and args.
         *
